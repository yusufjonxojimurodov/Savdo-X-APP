...
<template>
    <svg width="24px" height="24px" viewBox="0 0 366.34 366.34" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <path class="cls-5"
                d="M224.74,163s.29,5.65,1.62,8.3c.57,1.14,1.46,2.1,2,3.24,2.21,4.33-1.36,5.25-4.81,5.25"></path>
            <path class="cls-6"
            ...
            <path class="cls-8"
                d="M190.17,191.23a1.87,1.87,0,0,1,2.69-.5c2.07,1.46,5.88,4.56,11.28,5.63,7.36,1.47,13.74-1.48,15.27.42.86,1.07-.19,2.38-2.2,4.05a19.75,19.75,0,0,1-14.86,3.69c-7.08-1.33-12.4-9.53-12.4-12.44A1.79,1.79,0,0,1,190.17,191.23Z">
            </path>
            <ellipse class="cls-6" cx="187.13" cy="149.58" rx="3.27" ry="7.94"
                transform="translate(24.14 325.16) rotate(-85.77)"></ellipse>
            <ellipse class="cls-6" cx="238.63" cy="147.94" rx="7.94" ry="3.27"
                transform="translate(-19.94 38.53) rotate(-8.86)"></ellipse>
        </g>
    </svg>
</template>
