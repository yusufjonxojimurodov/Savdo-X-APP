...
import { IonBackButton, IonCard, IonSpinner } from '@ionic/vue';
...
import HeadphonesFilterComponent from './HeadphonesFilterComponent.vue';
...
<template>
    ...
    <div class="container !p-4">
        <div class="flex justify-between items-center w-full">
            ...
            <h1 class="title-page text-[#1e293b] !font-semibold !m-0">Quloqchinlar</h1>
        </div>
    </div>
    <banner-component />
    <headphones-filter-component />
    <div class="container flex justify-between items-center flex-wrap !mb-[20px]">
        ...
        <template v-else>
            <ion-card @click="setProductId(product._id)" v-for="product in filterProductStore.headphones"
                :key="product._id">
                ...
                <div class="flex justify-start items-start flex-col gap-2">
                    ...
                    <p class="text-[#3e3e3e] text-[12px] sm:text-[13px] md:text-[14px]">
                        ...
                        <router-link to=""
                            class="!text-[#3e3e3e] text-medium text-[12px] sm:text-[13px] md:text-[14px]">
                            Batafsil...
                        </router-link>
                    </p>
            ...
            <a-empty class="!text-white relative top-40 !mb-50 left-1/2 -translate-x-1/2 -translate-y-1/2"
                v-if="!filterProductStore.loader && filterProductStore.headphones.length === 0">
                <template #image>
